(function (global) {
  function initAdminI18n({
    ...
    const BASE_STRINGS = {
      ...
      llmSectionTitle: 'LLM',
      llmModelLabel: 'Model: {value}',
      llmBackendLabel: 'Backend: {value}',
      llmDeviceLabel: 'Device: {value}',
      llmPingButton: 'Ping',
      ollamaBaseLabel: 'Ollama Base:',
      ollamaModelNameLabel: 'Model name:',
      llmPromptsTitle: 'LLM Prompts',
      logsCardTitle: 'Logs (last 200)',
      labelServiceEnabled: 'Service enabled',
      autoStartLabel: 'Auto-start on launch',
      imapSslLabel: 'IMAP SSL',
      smtpStarttlsLabel: 'SMTP STARTTLS',
      labelUrl: 'URL',
      kbLimitLabel: 'Limit',
      logLinesLabel: 'Lines:',
    ...
    const LANGUAGES = {
      ...
      ru: createLanguage('Русский', 'ltr', {
        ...
        feedbackStatusOpen: 'Открыт',
        feedbackStatusInProgress: 'В работе',
        feedbackStatusDone: 'Решён',
        feedbackStatusDismissed: 'Отклонён',
        feedbackNoItems: 'Отзывов ещё нет.',
        reloadProjects: 'Обновить',
        llmSectionTitle: 'LLM',
        llmModelLabel: 'Модель: {value}',
        llmBackendLabel: 'Бэкенд: {value}',
        llmDeviceLabel: 'Устройство: {value}',
        llmPingButton: 'Проверить',
        ollamaBaseLabel: 'Адрес Ollama:',
        ollamaModelNameLabel: 'Название модели:',
        llmPromptsTitle: 'Промпты LLM',
        logsCardTitle: 'Логи (последние 200)',
        labelServiceEnabled: 'Сервис включён',
        autoStartLabel: 'Автозапуск при старте',
        imapSslLabel: 'IMAP SSL',
        smtpStarttlsLabel: 'SMTP STARTTLS',
        labelUrl: 'URL',
        kbLimitLabel: 'Лимит',
