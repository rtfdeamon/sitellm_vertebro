(function (global) {
  ...
  function initAdminI18n({
    ...
    const BASE_STRINGS = {
      ...
      crawlerStatusWaiting: 'Waiting to start',
      ...
      fileNoFileSelected: 'No files selected',
      fileFilesSelected: '{count} files selected',
      ...
      serviceStateOn: 'Service enabled',
      serviceStateOff: 'Service disabled',
      serviceStateLabelOn: 'Service: enabled',
      serviceStateLabelOff: 'Service: disabled',
      serviceModeAuto: 'Automatic',
      serviceModeManual: 'Manual (on demand)',
      serviceModeLabel: 'Mode: {value}',
      serviceStatusActive: 'Status: running',
      serviceStatusStopped: 'Status: stopped',
      knowledgeQueueLabel: 'Queue: {value}',
      knowledgeIdleLabel: 'Idle: {seconds} s',
      knowledgeLastRunLabel: 'Last run: {value}',
      knowledgeErrorLabel: 'Error: {value}',
      knowledgeReasonLabel: 'Reason: {value}',
      knowledgeUpdatedLabel: 'Updated: {value}',
      knowledgeServiceErrorUnsupportedExtension: 'Unsupported file extension',
      knowledgeServiceErrorWorkerTimeout: 'Background worker timeout',
      knowledgeServiceReasonManualButton: 'Manual start',
      knowledgeServiceReasonManual: 'Manual',
      knowledgeStatusUnknown: 'Status unavailable',
      knowledgeProcessingRunning: 'Processing is running',
      knowledgeProcessingFailedShort: 'Processing finished with an error',
      knowledgeProcessingSuccessShort: 'Processing finished successfully',
      knowledgeProcessingIdle: 'Processing idle',
      knowledgeProcessingDisabled: 'Processing disabled',
      integrationTokenPreview: 'Token: {value}',
      integrationTokenNotSet: 'Token not set',
      integrationAutoStart: 'Auto-start: {value}',
      integrationAutoStartEnabled: 'enabled',
      integrationAutoStartDisabled: 'disabled',
      integrationLastError: 'Last error: {value}',
      integrationTokenSavedPlaceholder: 'Token saved',
      integrationStatusRunning: 'Running',
      integrationStatusStopped: 'Stopped',
      integrationStatusUpdating: 'Updating status…',
      integrationStatusError: 'Status error',
      integrationActionInProgress: 'Working…',
      integrationActionFailed: 'Action failed',
      integrationActionStarted: 'Started',
      integrationActionStopped: 'Stopped',
      integrationTelegramSelectProject: 'Select a project to manage the Telegram bot.',
      integrationTelegramSaveHint: 'Save the token and start the Telegram bot.',
      integrationMaxSelectProject: 'Select a project to manage the MAX bot.',
      integrationMaxSaveHint: 'Save the token and start the MAX bot.',
      integrationVkSelectProject: 'Select a project to manage the VK bot.',
      integrationVkSaveHint: 'Save the token and start the VK bot.',
      statsSummaryTotal: 'Total {total} requests',
      statsSummaryTotalAverage: 'Total {total} requests · per day {average}',
      statsRangeLastDays: 'Last {days} days',
      intelligentProcessingSaved: 'Processing prompt saved successfully',
      intelligentProcessingSaveError: 'Failed to save processing prompt',
      intelligentProcessingRefreshed: 'Settings refreshed',
      intelligentProcessingRefreshError: 'Failed to refresh settings',
      intelligentProcessingNoAccess: 'Only super administrators can manage processing settings',
      ...
      knowledgeQaEmpty: 'No Q&A pairs yet.',
      knowledgeQaLoadError: 'Failed to load FAQ.',
      knowledgeQaSaving: 'Saving…',
      knowledgeQaSaved: 'Changes saved',
      knowledgeQaSaveError: 'Failed to save',
      knowledgeQaDeleting: 'Deleting…',
      knowledgeQaDeleted: 'Pair deleted',
      knowledgeQaDeleteError: 'Failed to delete pair',
      knowledgeQaDeleteConfirm: 'Delete this pair?',
      knowledgeQaProjectMissing: 'Select a project first.',
      knowledgeQaImportNoFile: 'Choose a file to import.',
      knowledgeQaImportUnsupported: 'Only CSV import supported at the moment.',
      knowledgeQaImporting: 'Importing…',
      knowledgeQaImportEmpty: 'File does not contain data.',
      knowledgeQaImportMissingColumns: 'Columns “Question” and “Answer” are required.',
      knowledgeQaImportSummary: 'Imported: {imported}, skipped: {failed}',
      knowledgeQaImportError: 'Failed to import file.',
      knowledgeQaEditQuestion: 'Edit question',
      knowledgeQaEditAnswer: 'Edit answer',
      knowledgeQaEditPriority: 'Set priority (higher value shows first)',
      knowledgeQaNewQuestion: 'Enter question',
      knowledgeQaNewAnswer: 'Enter answer',
      knowledgeQaNewPriority: 'Priority (optional, default 0)',
      knowledgeQaUnavailable: 'FAQ manager unavailable',
      knowledgeDeleteConfirm: 'Delete this document?',
      knowledgeDeleteSuccess: 'Document deleted',
      knowledgeDeleteError: 'Failed to delete document: {error}',
      knowledgeClearConfirm: 'Delete all knowledge?',
      knowledgeClearConfirmProject: 'Delete all knowledge for project "{project}"?',
      knowledgeClearProcessing: 'Clearing…',
      knowledgeClearSuccess: 'Knowledge cleared',
      knowledgeClearSuccessWithCount: 'Removed {count} items',
      knowledgeClearError: 'Failed to clear knowledge: {error}',
      kbLimitLabel: 'Limit',
      logLinesLabel: 'Lines:',
      logsLoadingLabel: 'Loading…',
      logsUpdatedLabel: 'Updated {time}',
      logsLoadFailed: 'Failed to load logs',
      logsAccessDenied: 'Logs are available only to super administrators.',
      llmPromptsEmptyForProject: 'No prompts recorded for the selected project yet.',
      llmPromptsAccessDenied: 'Prompt history is limited to super administrators.',
    ...
    const LANGUAGES = {
      ...
      ru: createLanguage('Русский', 'ltr', {
        ...
        fileSelectButton: 'Выбрать файлы',
        fileNoFileSelected: 'Файлы не выбраны',
        fileFilesSelected: '{count} файлов',
        knowledgeStatusUnknown: 'Статус недоступен',
        knowledgeProcessingRunning: 'Обработка выполняется',
        knowledgeProcessingFailedShort: 'Обработка завершилась с ошибкой',
        knowledgeProcessingSuccessShort: 'Обработка завершилась успешно',
        knowledgeProcessingIdle: 'Обработка в ожидании',
        knowledgeProcessingDisabled: 'Обработка отключена',
        integrationTokenPreview: 'Токен: {value}',
        integrationTokenNotSet: 'Токен не задан',
        integrationAutoStart: 'Автозапуск: {value}',
        integrationAutoStartEnabled: 'включён',
        integrationAutoStartDisabled: 'выключен',
        integrationLastError: 'Последняя ошибка: {value}',
        integrationTokenSavedPlaceholder: 'Токен сохранён',
        integrationStatusRunning: 'Запущен',
        integrationStatusStopped: 'Остановлен',
        integrationStatusUpdating: 'Обновляем статус…',
        integrationStatusError: 'Ошибка статуса',
        integrationActionInProgress: 'Выполняю…',
        integrationActionFailed: 'Ошибка действия',
        integrationActionStarted: 'Запущено',
        integrationActionStopped: 'Остановлено',
        integrationTelegramSelectProject: 'Выберите проект, чтобы управлять Telegram ботом.',
        integrationTelegramSaveHint: 'Сохраните токен и запустите Telegram бота.',
        integrationMaxSelectProject: 'Выберите проект, чтобы управлять MAX ботом.',
        integrationMaxSaveHint: 'Сохраните токен и запустите MAX бота.',
        integrationVkSelectProject: 'Выберите проект, чтобы управлять VK ботом.',
        integrationVkSaveHint: 'Сохраните токен и запустите VK бота.',
        statsSummaryTotal: 'Всего {total} запросов',
        statsSummaryTotalAverage: 'Всего {total} запросов · в день {average}',
        statsRangeLastDays: 'Последние {days} дней',
      ...
      ollamaJobSuccess: 'Установлено',
        ...
        serviceStateOn: 'Сервис включён',
        serviceStateOff: 'Сервис выключен',
        serviceStateLabelOn: 'Сервис: включён',
        serviceStateLabelOff: 'Сервис: выключен',
        serviceModeAuto: 'Автоматический',
        serviceModeManual: 'Ручной (по команде)',
        serviceModeLabel: 'Режим: {value}',
        serviceStatusActive: 'Статус: выполняется',
        serviceStatusStopped: 'Статус: остановлен',
        knowledgeQueueLabel: 'Очередь: {value}',
        knowledgeIdleLabel: 'Простой: {seconds} с',
        knowledgeLastRunLabel: 'Последний запуск: {value}',
        knowledgeErrorLabel: 'Ошибка: {value}',
        knowledgeReasonLabel: 'Причина: {value}',
        knowledgeUpdatedLabel: 'Обновлено: {value}',
        knowledgeServiceErrorUnsupportedExtension: 'Неподдерживаемое расширение файла',
        knowledgeServiceErrorWorkerTimeout: 'Превышено время ожидания фонового обработчика',
        knowledgeServiceReasonManualButton: 'Ручной запуск',
        knowledgeServiceReasonManual: 'Ручной',
        intelligentProcessingSaved: 'Промт обработчика успешно сохранён',
        intelligentProcessingSaveError: 'Не удалось сохранить промт обработчика',
        intelligentProcessingRefreshed: 'Настройки обновлены',
        intelligentProcessingRefreshError: 'Не удалось обновить настройки',
        intelligentProcessingNoAccess: 'Только супер администраторы могут управлять настройками обработки',
        ...
        knowledgeQaEmpty: 'Пары вопросов и ответов ещё не добавлены.',
        knowledgeQaLoadError: 'Не удалось загрузить FAQ.',
        knowledgeQaSaving: 'Сохраняем…',
        knowledgeQaSaved: 'Изменения сохранены',
        knowledgeQaSaveError: 'Не удалось сохранить',
        knowledgeQaDeleting: 'Удаляем…',
        knowledgeQaDeleted: 'Пара удалена',
        knowledgeQaDeleteError: 'Не удалось удалить пару',
        knowledgeQaDeleteConfirm: 'Удалить эту пару?',
        knowledgeQaProjectMissing: 'Сначала выберите проект.',
        knowledgeQaImportNoFile: 'Выберите файл для импорта.',
        knowledgeQaImportUnsupported: 'Сейчас поддерживается только импорт CSV.',
        knowledgeQaImporting: 'Импортируем…',
        knowledgeQaImportEmpty: 'Файл не содержит данных.',
        knowledgeQaImportMissingColumns: 'Нужны колонки «Question» и «Answer».',
        knowledgeQaImportSummary: 'Импортировано: {imported}, пропущено: {failed}',
        knowledgeQaImportError: 'Не удалось импортировать файл.',
        knowledgeQaEditQuestion: 'Измените вопрос',
        knowledgeQaEditAnswer: 'Измените ответ',
        knowledgeQaEditPriority: 'Укажите приоритет (чем выше, тем раньше показывается)',
        knowledgeQaNewQuestion: 'Введите вопрос',
        knowledgeQaNewAnswer: 'Введите ответ',
        knowledgeQaNewPriority: 'Приоритет (необязательно, по умолчанию 0)',
        knowledgeQaUnavailable: 'Управление FAQ недоступно',
        knowledgeDeleteConfirm: 'Удалить этот документ?',
        knowledgeDeleteSuccess: 'Документ удалён',
        knowledgeDeleteError: 'Не удалось удалить документ: {error}',
        knowledgeClearConfirm: 'Очистить всю базу знаний?',
        knowledgeClearConfirmProject: 'Очистить базу знаний для проекта «{project}»?',
        knowledgeClearProcessing: 'Очищаем…',
        knowledgeClearSuccess: 'База знаний очищена',
        knowledgeClearSuccessWithCount: 'Удалено записей: {count}',
        knowledgeClearError: 'Не удалось очистить базу знаний: {error}',
        kbLimitLabel: 'Лимит',
        logLinesLabel: 'Строк:',
